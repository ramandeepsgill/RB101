...
def update_match_score(player_total, dealer_total, player_wins, dealer_wins, no_of_ties)
  result = detect_result(dealer_total, player_total)
...
def reset_match_score(player_wins, dealer_wins, no_of_ties)
  if player_wins == WINS_TO_BE_GRAND_WINNER || dealer_wins == WINS_TO_BE_GRAND_WINNER
    player_wins = 0
    dealer_wins = 0
    no_of_ties = 0
    [player_wins, dealer_wins, no_of_ties]
...
loop do
  ...
  prompt "You have: #{player_cards[0]} and #{player_cards[1]}, for a total of #{player_total}." #1 cache
  ...
  if busted?(player_total) #4 cache
    ...
    player_wins, dealer_wins, no_of_ties = update_match_score(player_total, dealer_total, player_wins, dealer_wins, no_of_ties)
    ...
    if grand_winner?(player_wins, dealer_wins)
      ...
      player_wins, dealer_wins, no_of_ties = reset_match_score(player_wins, dealer_wins, no_of_ties)
    end
