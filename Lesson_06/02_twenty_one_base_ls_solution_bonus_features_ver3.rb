...
def display_result(dealer_cards, player_cards, dealer_total, player_total)
  ...
  display_hand_and_total(dealer_cards, player_cards, dealer_total, player_total)
  case result
  when :player_busted
...
prompt("Welcome to #{DEALER_HITS_TILL}!")
prompt("First to #{WINS_TO_BE_GRAND_WINNER} wins is the Grand Winner!")
prompt("######################################")
